...
var stui = {
	...
	mobile: {
		...
		slide: function() {
			$.getScript(siteUrl+"/js/flickity.pkgd.min.js", function() {
	...
	images: {
		lazyload: function() {
			$.getScript(siteUrl+"/js/jquery.lazyload.js", function() {
				$(".lazyload").lazyload({
					effect: "fadeIn",
					threshold: 200,
					failurelimit: 15,
	...
	common: {
		bootstrap: function() {
			$.getScript(siteUrl+"/js/bootstrap.min.js", function() {
		...
		headroom: function() {
			$.getScript(siteUrl+"/js/headroom.min.js", function() {
				$("#header-top", function() {
